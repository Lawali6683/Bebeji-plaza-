...
router.post('/register', async (req, res) => {
  ...
  try {
    ...
    const transporter = nodemailer.createTransport({ service: 'gmail', auth: { user: process.env.EMAIL_ADDRESS, pass: process.env.EMAIL_PASSWORD } });
    const mailOptions = {
      from: process.env.EMAIL_ADDRESS,
      to: email,
      subject: 'Your OTP Code',
      text: `Hello ${fullName}, welcome to Bebeji Plaza phone center. Your OTP code is ${otp}. This code is invalid after 2 days. Thanks, this message from owner Haruna Lawali, Leader Developer`
    };
